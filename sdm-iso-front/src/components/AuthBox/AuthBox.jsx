...
export function AuthBox(props) {
  ...
  // Function that will submit the email and password to backend for login
  const submitLogin = () => {
    // Here, you can use the 'login' function from the AuthContext
      ...
      <div className="relative bg-iso-offwhite w-2/5 h-2/3 shadow">
        ...
        <div className="w-full display-block text-center pr-7">
          ...
          <div className="w-full text-right p-7">
            <a className="text-iso-link-blue font-regular pr-5" href="/protected">
              Sign in with SSO
            </a>
