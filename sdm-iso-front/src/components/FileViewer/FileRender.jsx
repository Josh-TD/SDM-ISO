            ...
            <div class="flex flex-wrap justify-between items-center mx-auto">
                <div class="flex items-center ">
                    ...
                    <button onClick={downloadHandler}
                        ...
                        <span id="modal-download-button">Download</span>
                        {download && <FileDownloader fileName={filename} />}
                    </button>
                </div>
                <div className='flex-exit flex justify-end'>
                    {/* Exit Button */}
                    <button onClick={exitHandler} id="modal-exit-button" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                        <IoMdExit />
                    </button>
                </div>
            </div>
